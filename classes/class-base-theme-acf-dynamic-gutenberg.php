...
if ( ! class_exists( 'Base_Theme_ACF_Gutenberg_Functions' ) ) {
	 ...
	 */
	class Base_Theme_ACF_Gutenberg_Functions {

        public function __construct() {

            add_filter( 'block_categories', array( $this,'base_theme_add_acf_block_category'), 10, 2 );
            
            add_action( 'acf/init', array( $this,'base_theme_register_dynamic_acf_blocks') );

            add_action( 'acf/render_field_group_settings', array( $this,'base_theme_add_acf_fieldgroup_fields_for_blocks'), 10, 1 );

            add_filter( 'acf/validate_field_group', array( $this,'base_theme_acf_fieldgroup_save_as_block'), 10, 1 );

            add_action( 'manage_edit-acf-field-group_columns', array( $this,'base_theme_debug_acf_add_admin_column_block_template'), 35, 1 );

            add_action( 'manage_acf-field-group_posts_custom_column', array( $this,'base_theme_debug_acf_output_block_template_column'), 10, 2 );
        ...
        */
        public function base_theme_add_acf_block_category( $categories, $post ) {
            return array_merge(
                $categories,
                array(
                    array(
        ...
        */        
        public function base_theme_register_dynamic_acf_blocks() {
                    ...
                    if ( ! empty( $field_group['as_block'] ) && 1 === $field_group['as_block'] ) {
                        ...
                        acf_register_block(
                            array(
                                ...
                                'render_callback' => array($this, 'base_theme_render_dynamic_acf_block_partial'),
        ...
        */
         ...
         * @return void
        */
        public function base_theme_render_dynamic_acf_block_partial( $block ) {
            // Convert name ("acf/block_name") into path friendly slug.
            $slug  = str_replace( 'acf/', '', $block['name'] );
            $title = $block['title'];
         ...
         * @return void
        */
        public function base_theme_add_acf_fieldgroup_fields_for_blocks( $field_group ) {
        ...
        */
        public function base_theme_acf_fieldgroup_save_as_block( $field_group ) {
            if ( ! empty( $field_group['as_block'] ) && 1 === $field_group['as_block'] ) {
         ...
         * @return array
        */
        public function base_theme_debug_acf_add_admin_column_block_template( $defaults ) {
         ...
         * @return void
        */
        public function base_theme_debug_acf_output_block_template_column( $column, $post_id ) {
...
new Base_Theme_ACF_Gutenberg_Functions();