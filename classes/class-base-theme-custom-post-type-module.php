    ...
    class Base_Theme_ACF_Custom_Post_Type_Module{
        ...
        public function base_theme_custom_get_post_types() {
            ...
            $custom_post_types_arr[] = array(
                ...
                'supports'           => array( 'title', 'thumbnail', 'excerpt', 'editor', 'page-attributes', 'post-formats', 'revisions', 'custom-fields', 'trackbacks', 'comments', 'author' ),
                'has_archive'        => false,
                'taxonomies'         => true,    
            );
        ...
        public function base_theme_custom_get_category_types() {
            ...
            $category_types_arr[] = array(
                ...
                'plural'    => 'Locations',
                'slug'      => 'post-location',
                'post_type' => array( 'recipes', 'localpalate_podcasts','localpalate_events','city_guides','restaurants','howto','post' ),   
                'public'    => 0,  
            );  
                ...
                foreach( $posttypes as $posttype ):
                    ...
                    $args = array_merge(		 
                        ...
                        array(
                            ...
                            'show_in_rest'          => true,
                            'rewrite'               => array( 'slug' => $posttype['rewrite'], 'with_front' => false ),
            ...
            if( $custom_taxonomies ):
                ...
                foreach( $custom_taxonomies as $custom_taxonomy ):
                    ...
                    $taxonomy_labels = array(
                        ...
                        'menu_name'             => __( $taxonomy_plural, $this->text_doamin ),
                    );
